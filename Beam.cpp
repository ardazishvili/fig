...
namespace fig {
Beam::Beam(Shader& shader, glm::vec3 begin, glm::vec3 end, float r,
...
void Beam::render() {
  ...
  model = glm::rotate(model, _ozAngle, _zUnit);
  model = glm::rotate(model, _oyAngle, _yUnit);
  model = glm::rotate(model, angle, _zUnit);
