...
void LinesObject::initBuffers() {
  ...
  glBufferData(GL_ARRAY_BUFFER, sizeof(glm::vec3) * _v.size(), &_v[0],
               GL_DYNAMIC_DRAW);
  glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, sizeof(glm::vec3), (void*)0);

  glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, _ebo);
  glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof(_i[0]) * _i.size(), &_i[0],
               GL_DYNAMIC_DRAW);
...
unsigned int LinesObject::indicesToRender() { return _i.size() * 2; }
}  // namespace fig
