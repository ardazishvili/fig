...
Shader::Shader(Light* light, Camera& camera, glm::mat4& view,
               glm::mat4& projection, const std::string& vertexPath,
               const std::string& fragmentPath)
    : _light(light), _camera(camera), _view(view), _projection(projection) {
...
void Shader::setVec3(const std::string& name, float f1, float f2,
                     float f3) const {
...
Camera& Shader::camera() { return _camera; }
}  // namespace fig
